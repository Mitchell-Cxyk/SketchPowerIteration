...
for iter=1:numel(decayRateList)
    ...
    testYinC(decay,decayRateList(iter));
    % testTYUC17SPI(500,2000,decay,decayRateList(iter));
    % testYinCW0(decay,decayRateList(iter));
end
decay='lowrank';
...
for iter=1:numel(decayRateList)
    ...
    decayRate=decayRateList(iter)
    testYinC(decay,decayRateList(iter));
    % testTYUC17SPI(3000,300,decay,decayRateList(iter));
    % testYinCW0(decay,decayRateList(iter));
end
