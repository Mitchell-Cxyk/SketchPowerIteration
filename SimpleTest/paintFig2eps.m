% 设置文件夹路径
figFolder = './singularValueSyne'; % 替换为你的 .fig 文件所在文件夹路径
outputFolder = 'C:\Users\cxyk3\Documents\Paper-LaTeX\SketchPower\SMfigure\Synethetic\singularValue'; % 替换为保存 .eps 文件的文件夹路径
