...
r=10;l=80;s=20;MentoCarloNum=50;d=100;
...
createAcademicScatter(data1,'BoundaryType','shaded','ShowMeanLine',true,'XLabel','Iteration Number','YLabel','Relative Frobenius Error');
normA=svd(A);normA=normA(r+1);
relativeErrS=errS./normA-1;
data=formatScatterData(qlist',relativeErrS');
createAcademicScatter(data,'BoundaryType','shaded','ShowMeanLine',true,'XLabel','Iteration Number','YLabel','RelativeSpectral Error');
