...
r=10; T=300; m=10512; n=28144;decay='poly';decayRate=0.68;MenteCarloNum=10;
errList=zeros(2,T);
...
UU=QQ*UU;
relativeErrorRSVD=norm(QQ*UU(:,1:r)*SS(1:r,1:r)*VV(:,1:r)'-dataMatrix,'fro');
errList(2,s)=relativeErrorRSVD;
end
end
