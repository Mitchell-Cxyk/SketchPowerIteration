...
errListSpec(3,iter)=estspecnorm(lowrankapprox.U*lowrankapprox.S*lowrankapprox.V'-lowrankapprox.U*(lowrankapprox.U'*imageMatrix20000))/normSbest;
save(['dataBestT/T190_s_',num2str(s),'.mat'],"lowrankapprox","errListSpec","errList");
end
end