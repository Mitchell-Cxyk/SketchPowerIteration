% 设置文件夹路径
figFolder = './figure/NISTSingularVector/SingularVectorError/'; % 替换为你的 .fig 文件所在文件夹路径
outputFolder = 'C:\Users\cxyk3\Documents\Paper-LaTeX\SketchPower\figure\NIST\SingularVector'; % 替换为保存 .eps 文件的文件夹路径
